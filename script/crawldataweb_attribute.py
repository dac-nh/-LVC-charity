...
for i in range(n):
  ...
  objects.append(extract_attribute(content, 'object', object_words, 'object_word', n_object, 0.2, 'Vui lòng đọc bài đầy đủ ở link để biết thông tin chi tiết!'))
...
for i in range(n_kindmate):
  ...
  organizations.append(extract_attribute(content, 'org', org_words, 'org_word', n_org, 1, 'Vui lòng đọc bài đầy đủ ở link để biết thông tin chi tiết!'))
